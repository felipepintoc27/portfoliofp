    ...
    <section className="py-16 md:py-24 border-t border-slate-700">
      ...
      <div>
        ...
        <div className="space-y-8">
            <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 text-center max-w-5xl mx-auto w-full">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-center max-w-5xl mx-auto w-full">
             ...
             <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 max-w-5xl mx-auto w-full">
